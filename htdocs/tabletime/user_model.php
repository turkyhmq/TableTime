...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frmnewadd")) {
  $resitd = $_POST['restid'];
    ...
    if($found == 0):
        ...
        $newuserid = mysqli_insert_id($conx);
        $qry = "INSERT INTO ".$dbprefix."restaurants_employee (restid, userid) VALUES ('$resitd','$newuserid')";
...
$qry = "SELECT * FROM ".$dbprefix."users
        WHERE userid IN (
          SELECT re.userid FROM ".$dbprefix."restaurants_employee re
    ...
    <?php if(count($UserAry) > 0): ?>
      <table width="100%" cellpadding="0" cellspacing="0" class="table table-stripped">
        <tr style="background-color: #f2f2f2;">
          <td width="436"><strong>Username </strong></td>
        ...
        <tr>
          ...
          <a href="#" id="del_<?php echo $row->userid ?>" title="Delete" class="del btn" style="background-color: red; color: white;"><i class="fa fa-trash"></i></a>
    ...
    <form id="frmnewadd" name="frmnewadd" method="POST" enctype="multipart/form-data" >
      <table align="center" cellpadding="0" cellspacing="0" class="table">
        ...
        <tr>
          ...
          <td><select id="restid" name="restid" class="form-control">
